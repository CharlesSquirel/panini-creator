...
import { ResetContextProvider } from './services/context/ResetContext';
    ...
    <ResetContextProvider>
      <FormComponentProvider>
        <FormContainer title="Configure Base">
          <CarouselInput title="Bread" data={breadVariants} isSwitched={false} name="base.bread" initialValue={initialValues.base.bread} />
          <SelectInput title="Cheese" data={cheeseVariants} name="base.cheese" />
          <SelectInput title="Meat" data={meatVariants} name="base.meat" />
          <CarouselInput title="Dressing" data={dressingVariants} isSwitched name="base.dressing" initialValue={initialValues.base.dressing} />
          <VegetablesSelect />
        </FormContainer>
        <FormContainer title="Configure Extras">
          <SelectInput title="Egg" data={eggVariants} name="extras.egg" />
          <CheckboxInput title="Spreads" data={spreadVariant} value={[]} name="extras.spreads" />
          <RadioInput title="Serving" data={servingVariants} name="extras.serving" />
          <CheckboxInput title="Topping" data={toppingVariant} value={null} name="extras.topping" />
        </FormContainer>
        <FormContainer title="Finalize Order" isLast>
          <TextInput title="Name panini" placeholder="eg. Club Panini" name="sandwichName" />
          <CheckboxInput title="Cutlery" data={cutleryVarriants} value={initialValues.cutlery} name="cutlery" />
          <CheckboxInput title="Napkins" data={napkinVarriants} value={initialValues.napkins} name="napkins" />
